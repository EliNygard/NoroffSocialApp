...
export default async function router(pathname = window.location.pathname) {
  switch (pathname) {
    ...
    case "/NoroffSocialApp/profile/index.html":
      ...
      break;
    case "/NoroffSocialApp/profiles/":
    case "/NoroffSocialApp/profiles/index.html":
      await import("./views/profiles.js");
      break;
    case "/NoroffSocialApp/profiles/posts/":
    case "/NoroffSocialApp/profiles/posts/index.html":
      await import("./views/postsByProfile.js");
      break;
    case "/NoroffSocialApp/profiles/profile/":
    case "/NoroffSocialApp/profiles/profile/index.html":
